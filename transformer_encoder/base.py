...
from layers import Layer, Dense, WordEmbedding, PositionalEncoding, MultiHeadAttention, SelfAttention, LayerNormalization
...
class Sequential:
    ...
    def load_model(self, file_name: str):
        with open('model_weights/' + file_name, 'r') as file:
